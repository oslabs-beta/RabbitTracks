// This component represents a data table for displaying messages
...
export default function DataTable(props: DataTableProps) {
  ...
  const GridCellExpand: React.FunctionComponent<GridCellExpand> = React.memo(
    function GridCellExpand(props: GridCellExpandProps) {
  ...
  const columns: Columns = [
    {
      field: "consumerTag",
      headerName: "consumerTag",
      renderCell: renderCellExpand,
      flex: 1.5,
    },
    {
      field: "deliveryTag",
      headerName: "deliveryTag",
      renderCell: renderCellExpand,
      flex: 1,
    },
    {
      field: "redelivered",
      headerName: "redelivered",
      renderCell: renderCellExpand,
      flex: 1,
    },
    {
  ...
  const rows: Rows = messages.map((el) => {
    return {
      ...
      timestamp: el.timestamp
        ? new Date(Number(el.timestamp)).toISOString()
        : "",
      type: el.type,
      userId: el.userid,
      appId: el.appid,
